// <auto-generated />
namespace WebApi.Properties.Resources
{
    ...
    {
        /// <summary>
        /// A string like "There was a error executing the operation. {0}"
        /// </summary>
        internal static string WebApiError(object p0)
        {
            return EntityRes.GetString(EntityRes.WebApiError, p0);
        }
    } 
    ...
    {
        internal const string WebApiError = "WebApiError";
